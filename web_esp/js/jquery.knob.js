  ...
  var Dial = function (c, opt) {
    ...
    this.startDrag = function (e) {
      ...
      $doc
        ...
        .bind("mouseup.dial touchend.dial", function (e) {
          $doc.unbind(
            "mousemove.dial touchmove.dial mouseup.dial touchend.dial keyup.dial"
          );
          self.val(self.val());
          self.onRelease(v);
        });
    ...
    return this.each(function () {
      ...
      opt = $.extend(
        {
          ...
          tickColor:
            $this.data("tickColor") || $this.data("fgcolor") || "#DDDDDD",
      ...
      if (!opt.readOnly) {
        ...
        var kval,
          ...
          to,
          m = 1,
          kv = { 37: -1, 38: 1, 39: 1, 40: -1 };
        $this
          .bind("configure", function (e, aconf) {
            var kconf;
            for (kconf in aconf) {
          ...
          .bind("keyup", function (e) {
            if (isNaN(kval)) {
              if (to) {
                ...
                // enter
                e.keyCode === 13 && k.onRelease($this.val(), $this);
              }
            } else {
              // kval postcond
